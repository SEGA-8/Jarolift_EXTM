...
Experimental version. Use at your own risk. For private/educational use only. (Keeloq algorithm licensed only to TI Microcontrollers)
...
This is the external I2C EEPROM and MQTT version of Jarolift_RX_TX_FHEM, which was originally developed to operate with the 
...
Modified by Simon Eduardo Gonzalez Abad in Gen, 2021
...
* copy the folder `E24` to the arduino library folder
...
ESP | 24LC256 | Remark
------|------|------
D3 | SDA | (10Kohm to VCC)
D4 | SCL | (10Kohm to VCC)
GND | A0 A1 A2 WP
GND | GND
VCC | VCC | 3.3v
